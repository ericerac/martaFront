                    ...
                    <div class="bloc_text_thumb ">
                        ...
                        <div class="bloc_synopsis" :class="darkTheme ? 'txtDark' : 'txtDay'">
                            ...
                            <div class="bloc_sinopsis_text">
                                ...
                                <p class="sinopsis" :class="darkTheme ? 'txtDark' : 'txtDay'">{{ pageData[0].synopsis_1 }}
                                </p>
                        ...
                        <div class="bloc_text_video">
                            <div class="fiches">
                                <div class="fiche_art fiche" :class="darkTheme ? 'txtDark' : 'txtDay'">
                                    ...
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_1 }} </strong> {{
                                        pageData[0].p_2 }}</p>
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_3 }}</strong> {{
                                        pageData[0].p_4 }}</p>
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_5 }} </strong> {{
                                        pageData[0].p_6 }}</p>
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_7 }} </strong> {{
                                        pageData[0].p_8 }}</p>
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_9 }}</strong> {{
                                        pageData[0].p_10 }}</p>
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_11 }} </strong> {{
                                        pageData[0].p_12 }}</p>
                                    <p :class="darkTheme ? 'txtDark' : 'txtDay'"><strong>{{ pageData[0].p_13 }} </strong> {{
                                        pageData[0].p_14 }} </p>
